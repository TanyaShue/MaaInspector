...
<template>
  <div v-if="visible" class="fixed inset-0 z-[200] flex items-center justify-center bg-black/30 backdrop-blur-sm">
    <div class="bg-white rounded-xl shadow-2xl border border-slate-200 w-[380px] overflow-hidden animate-in zoom-in-95 fade-in duration-200" @mousedown.stop>
      ...
      <div class="px-5 py-4">
        <p class="text-sm text-slate-600">
          您正在切换到另一个文件，当前文件 <span class="font-mono font-bold text-slate-800">{{ filename }}</span> 有未保存的更改。
        </p>
